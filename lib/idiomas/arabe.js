...
const smsLista1 = () => { return `🌟 معلومات ◤𝙀𝙈𝙋𝙀𝙍𝙊𝙍🦂𝘼𝙉𝙐𝙎◢-𝑩𝑶𝑻 🌟`}
const smsLista2 = () => { return `💖 المطور 💖`}
const smsLista3 = () => { return `🎁 تبرع: الدعم 🎁`}
const smsLista4 = () => { return `🚀 سرعه البوت 🚀`}
const smsLista5 = () => { return `💡 معلومات القائمة 💡`}
const smsLista6 = () => { return `🌀 كل الاوامر  🌀`}
const smsLista7 = () => { return `🐈 تثبيت ◤𝙀𝙈𝙋𝙀𝙍𝙊𝙍🦂𝘼𝙉𝙐𝙎◢-𝑩𝑶𝑻 🐈`}
const smsLista8 = () => { return `🍄 كن 𝑺𝑼𝑩 𝑩𝑶𝑻 🍄`}
...
const smsLista23 = () => { return `🌟 قائمه المرح 🌟`}
...
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *غادر المجموعه،من باعنا فليسئ منا* 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز ◤𝙀𝙈𝙋𝙀𝙍𝙊𝙍🦂𝘼𝙉𝙐𝙎◢ 𝑩𝑶𝑻-𝑴𝑫 - 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 '}
...
//نص
const smsConMenu = () => { return `☘️انوسي هت الاوامر`}
...
//متجر
const eExp = () => { return '⚡خبرة ' } 
const eDiamante = () => { return '💎 الماس ' } 
const eDiamantePlus = () => { return '💎+ الماس+' }
const eToken = () => { return '🪙 توكين' } 
const eEsmeralda = () => { return '💚 زمرد ' } 
const eJoya = () => { return '♦️ جوهر ' }
const eMagia = () => { return '🌀 سحر' } 
const eOro = () => { return '👑 ذهب ' } 
const eGataCoins = () => { return '🐱 كوما كوينز' }
const eGataTickers = () => { return '🎫 مؤشرات كوما' } 
const eEnergia = () => { return '✨ طاقة' }

const ePocion = () => { return '🥤 جرعه' }
const eAgua = () => { return '💧 ماء' }
const eBasura = () => { return '🗑 مُخَلَّفَات' }
...
const eLata = () => { return '🥫 علبة' }
const eCarton = () => { return '🪧 ورق مقوي ' } 

const eEletric = () => { return '💡 كهرباء' }
const eBarraOro = () => { return '〽️ شريط ذهب' }
const eOroComun = () => { return '🧭 الذهب المشترك' }
const eZorroG = () => { return '🦊🌫️ الثعلب الكبير' }
const eBasuraG = () => { return '🗑🌫️ سوبر القمامة' }
const eLoboG = () => { return '🐺🌫️ سوبر ألذئب' }
const eMaderaG = () => { return '🛷🌫️ سوبر خشب' }
const eEspada = () => { return '⚔️ سيف' }
const eCarnada = () => { return '🪱 طعم' }
const eBillete = () => { return '💵 مال' }
const ePinata = () => { return '🪅بينياتا ' }
const eGancho = () => { return '🪝 خطاف ' }
const eCanaPescar = () => { return '🎣 سنارة صيد' } 

const eCComun = () => { return '📦 الصندوق الشائع' }
...
const eManzana = () => { return '🍎 تفاح' }
const eNaranja = () => { return '🍊 برتقال' }
const eMango = () => { return '🥭 أنبج' }
...
const eCentauro = () => { return '🐐 قنطور' }
const eAve = () => { return '🦅 طير' }
const eGato = () => { return '🐈 قط' }
const eDragon = () => { return '🐉 تنين' }
const eZorro = () => { return '🦊 ثعلب' }
const eCaballo = () => { return '🐎 حصان' }
const eFenix = () => { return '🕊️ فينكس' }
const eLobo = () => { return '🐺 ذئب' }
const ePerro = () => { return '🐶 كلب ' } 

const eAMascots = () => { return '🍖 طعام الحيوانات الأليفة' }
const eCCentauro = () => { return '🐐🥩 سنتور فود' }
...
const eCFenix = () => { return '🕊️🥩 فينيكس فود' } 
...
const smsModP2 = () => { return `تمكين الوظيفة حتى يتمكن الجميع من استخدام 𝑬𝑳𝑮𝑨𝒁𝑨𝑹-𝑩𝑶𝑻`}
const smsModAd1 = () => { return `🛂 وضع المشرف`}
const smsModAd2 = () => { return `سيتمكن المسؤولون فقط من استخدام 𝑬𝑳𝑮𝑨𝒁𝑨𝑹-𝑩𝑶𝑻 في المجموعات`}
...
const smsAntiE2 = () => { return `احذف الأشخاص الذين يرسلون روابط من مجموعات واتساب`}
...
const smsAntiTT2 = () => { return `إزالة الأشخاص الذين يرسلون روابط تيكتوك`}
...
const smsAntiFB2 = () => { return `قم بإزالة الأشخاص الذين يرسلون روابط فيسبوك`}
const smsAntiIG1 = () => { return `🔗 مضاد إنستغرام`}
const smsAntiIG2 = () => { return `قم بإزالة الأشخاص الذين يرسلون روابط انستجرام`}
...
const smsSOLOP2 = () => { return `السماح باستخدامه فقط في الخاص`}
const smsSOLOG1 = () => { return `⚜️ المجموعات فقط`}
const smsSOLOG2 = () => { return `السماح باستخدامه فقط في المجموعات`}
