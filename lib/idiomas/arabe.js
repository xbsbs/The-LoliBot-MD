...
const smsLista1 = () => { return `🌟 معلومات 𝑬𝑳𝑮𝑨𝒁𝑨𝑹-𝑩𝑶𝑻 🌟`}
...
const smsLista7 = () => { return `🐈 تثبيت 𝑬𝑳𝑮𝑨𝒁𝑨𝑹-𝑩𝑶𝑻 🐈`}
...
//_allantilink.js
const smsTextoYT = () => { return '😻 ممتاز 𝑬𝑳𝑮𝑨𝒁𝑨𝑹 𝑩𝑶𝑻-𝑴𝑫 - 𝑾𝑯𝑨𝑻𝑺𝑨𝑷𝑷 '}
...
//نص
const smsConMenu = () => { return `☘️ الاوامر`}
